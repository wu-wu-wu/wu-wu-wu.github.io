...
;(function() {
  ...
  var options = {
    'maxPageWidth' :     '1088px',                      // set overlay width to match page width (as max-width for flexible grids)
    'columnWidth' :      '80px',                        // set column width in px
    'columnCount' :       10,                           // set column count
    'columnColor' :      'rgba(255, 0, 0, 0.25)',       // set column color
    'gutterWidth' :      32,                            // set gutter width in px
    'baselineHeight' :    32,                           // set baseline height in px
    'baselineColor' :    'rgba(2, 3, 2, 1)',            // set baseline color
